package manager.ui.splash.apng;

import static manager.ui.splash.apng.APNG.IDAT_SIG;
import static manager.ui.splash.apng.APNG.PNG_SIG;
import static manager.ui.splash.apng.APNG.acTL_SIG;
import static manager.ui.splash.apng.APNG.fcTL_SIG;
import static manager.ui.splash.apng.APNG.fdAT_SIG;
...
class APNGReader {
    ...
    private ByteBuffer unfilter(int width, int height, ByteBuffer data) {
        ByteBuffer pixels = ByteBuffer.allocate(/*width * height*/data.capacity());
