...
public class EntityModel extends AbstractModel implements IPropertyChangeListener {
    ...
    EntityModel(EntityRef<? extends Entity> owner, Class<? extends Entity> entityClass, String PID) {
        ...
        if (owner != null) {
            ...
            EntityRef<Entity> ownerRef = new EntityRef<>(tableClass.asSubclass(Entity.class));
